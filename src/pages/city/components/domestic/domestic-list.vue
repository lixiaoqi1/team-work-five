<template>
    <div class="city-box">
            ...
            <div class="city-content-main">
                <ul>
                    <li class="city-content-item">
                        <a href="javascript:;" class="city-content-link">{{domesticInfo.China.currentCity}}</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="city-content">
            ...
            <div class="city-content-main">
                <ul>
                    <li class="city-content-item" v-for="item in domesticInfo.China.hotCity" :key="item.id">
        ...
        <div class="city-items">
            <div class="city-items-type" v-for="item in domesticInfo.China.citys" :key="item.id">
                <h3 class="city-content-title  borders no-border-bottom" ref="initial">{{item.text}}</h3>
                <ul>
        ...
        <div class="domestic-word" id="domestic-word">
            <a href="javascript:;" class="domestic-word-link" v-for="item in domesticInfo.China.citys" :title="item.id" @touchstart="handleTouchStart">{{item.text}}</a>
        </div>
    </div>
</template>
...
<script>
	...
	export default{
        ...
        methods: {
            ...
            handleTouchMove(e) {
                e.preventDefault();
                let listBox=document.getElementById("domestic-word");
